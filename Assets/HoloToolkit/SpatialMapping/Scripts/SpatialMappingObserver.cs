...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class SpatialMappingObserver : SpatialMappingSource
    {
        ...
        /// </summary>
        private UnityEngine.VR.WSA.SurfaceObserver observer;

        /// <summary>
        /// A queue of surfaces that need their meshes created (or updated).
        /// </summary>
        private readonly Queue<UnityEngine.VR.WSA.SurfaceId> surfaceWorkQueue = new Queue<UnityEngine.VR.WSA.SurfaceId>();
        ...
        public void StartObserving()
        {
            if (observer == null)
            {
                observer = new UnityEngine.VR.WSA.SurfaceObserver();
                SwitchObservedVolume();
            }
