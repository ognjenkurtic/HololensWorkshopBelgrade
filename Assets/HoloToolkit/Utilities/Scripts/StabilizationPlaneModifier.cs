...
namespace HoloToolkit.Unity
{
    ...
    public class StabilizationPlaneModifier : Singleton<StabilizationPlaneModifier>
    {
        ...
        private void ConfigureTransformOverridePlane(float deltaTime)
        {
            ...
            UnityEngine.VR.WSA.HolographicSettings.SetFocusPointForFrame(planePosition, -GazeNormal, velocity);
        }
        ...
        private void ConfigureGazeManagerPlane(float deltaTime)
        {
            ...
            UnityEngine.VR.WSA.HolographicSettings.SetFocusPointForFrame(planePosition, -gazeDirection, Vector3.zero);
        }
        ...
        private void ConfigureFixedDistancePlane(float deltaTime)
        {
            ...
            UnityEngine.VR.WSA.HolographicSettings.SetFocusPointForFrame(planePosition, -gazeNormal, Vector3.zero);
        }
