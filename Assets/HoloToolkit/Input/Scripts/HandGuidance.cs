...
namespace HoloToolkit.Unity.InputModule
{
    ...
    public class HandGuidance : Singleton<HandGuidance>
    {
        ...
        protected override void Awake()
        {
            ...
            UnityEngine.VR.WSA.Input.InteractionManager.SourceLost += InteractionManager_SourceLost;
            UnityEngine.VR.WSA.Input.InteractionManager.SourceUpdated += InteractionManager_SourceUpdated;
            UnityEngine.VR.WSA.Input.InteractionManager.SourceReleased += InteractionManager_SourceReleased;
        }
